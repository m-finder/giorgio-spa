...
import FormRulesOne from '@admin/views/pages/formRules/component/formRulesOne.vue';
import FormRulesTwo from '@admin/views/pages/formRules/component/formRulesTwo.vue';
import FormRulesThree from '@admin/views/pages/formRules/component/formRulesThree.vue';
