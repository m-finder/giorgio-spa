...
import LimitsFrontEndPage from '@admin/views/limits/frontEnd/page/index.vue';
import Auth from '@admin/components/auth/auth.vue';
import Auths from '@admin/components/auth/auths.vue';
import AuthAll from '@admin/components/auth/authAll.vue';
import { auth, auths, authAll } from '@admin/utils/authFunction';
