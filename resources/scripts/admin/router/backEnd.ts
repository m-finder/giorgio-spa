...
import { useRequestOldRoutes } from '@admin/stores/requestOldRoutes';
...
import { useMenuApi } from '@admin/api/menu/index';
...
export async function initBackEndControlRoutes() {
	...
	// 处理路由（component），替换 dynamicRoutes（@admin/router/route）第一个顶级 children 的路由
