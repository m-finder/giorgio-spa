...
import Aside from '@admin/layout/component/aside.vue';
import Header from '@admin/layout/component/header.vue';
import Main from '@admin/layout/component/main.vue';
import ColumnsAside from '@admin/layout/component/columnsAside.vue';
