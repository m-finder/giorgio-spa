...
// 引入组件
const LayoutAside = defineAsyncComponent(() => import('@admin/layout/component/aside.vue'));
const LayoutHeader = defineAsyncComponent(() => import('@admin/layout/component/header.vue'));
const LayoutMain = defineAsyncComponent(() => import('@admin/layout/component/main.vue'));
