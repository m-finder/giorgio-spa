		...
		<el-dropdown :show-timeout="70" :hide-timeout="50" @command="onHandleCommandClick">
			...
			<template #dropdown>
				<el-dropdown-menu>
					...
					<el-dropdown-item command="/password">{{ $t('message.router.password') }}</el-dropdown-item>
...
import { Session, Local } from '@admin/utils/storage';
import UserNews from '@admin/layout/navBars/breadcrumb/userNews.vue';
import Search from '@admin/layout/navBars/breadcrumb/search.vue';
