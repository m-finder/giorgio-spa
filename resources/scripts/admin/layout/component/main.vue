...
// 引入组件
const LayoutParentView = defineAsyncComponent(() => import('@admin/layout/routerView/parent.vue'));
const LayoutFooter = defineAsyncComponent(() => import('@admin/layout/footer/index.vue'));
